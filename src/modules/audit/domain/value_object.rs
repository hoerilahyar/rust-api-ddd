...
/// Query params accepted by `GET /audit/login-logs`. Deliberately separate
...
pub struct LoginLogQuery {
    #[serde(default = "LoginLogQuery::default_page")]
    pub page: i64,
    #[serde(default = "LoginLogQuery::default_limit")]
    pub limit: i64,
    /// Matches against `email_attempted` or `ip_address` (partial, case-insensitive).
    #[serde(default)]
