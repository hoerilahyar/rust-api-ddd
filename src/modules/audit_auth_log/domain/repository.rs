...
use crate::modules::audit_auth_log::domain::{LoginLog, LoginLogQuery};
...
/// `shared::contracts::AuditAuthRecorder` instead, so this module can never
/// tamper with the audit trail it's meant to expose.
#[async_trait]
pub trait AuditAuthLogRepository: Send + Sync {
