...
use crate::modules::log_audit_auths::presentation::handler;
...
pub fn routes(state: AppState) -> Router<AppState> {
    Router::new()
        .route("/audit-auth", get(handler::list_audit_auth_logs))
        .route("/audit-auth/:id", get(handler::get_audit_auth_log))
